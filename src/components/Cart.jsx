              ...
              <div className="container py-5">
                <div className="row">
                    <div className="col-md-12 text-center">
                        ...
                        <Link to={"/"} className ="btn btn-primary text-center mt-3">Continuar Comprando</Link>
                    </div>
                </div>
              </div>  
            )
        ...
        <div id="itemList" className="container py-5">
            <div className="row">
                ...
                <table class="table">
                        <thead>
                            <tr>
                                <th scope="col" colSpan={5} className ="text-end"><Link onClick={clear} className="btn btn-secondary mb-3" title="Vaciar Carrito">Vaciar Carrito</Link></th> 
                            </tr>
                            <tr>
                                <th scope="col">&nbsp;</th>
